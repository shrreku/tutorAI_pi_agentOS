    ...
    <div className="tb-card">
      ...
      {data ? (
        <dl className="tb-admin-stats">
          ...
          <div>
            <dt>Activated learners</dt>
            <dd>{data.counts.activatedLearners}</dd>
          </div>
          <div>
            <dt>Credit exhausted</dt>
            <dd>{data.counts.creditExhausted}</dd>
          </div>
          <div>
            <dt>Failed ingestion</dt>
            <dd>{data.counts.failedIngestion}</dd>
          </div>
          <div>
            <dt>Pending feedback</dt>
            <dd>{data.counts.pendingFeedback}</dd>
          </div>
        </dl>
      ) : null}
    </div>
