...
**Role:** Design north star — improvement priority: completeness → aesthetic polish → structural change. **Not shipped in hosted beta** until kit parity; production stays Mist Glass until coordinated migration.
...
Use [`ui-example/mist-glass/`](../mist-glass/README.md) as the anatomy checklist; [`NODES_PEN.md`](../../NODES_PEN.md) for interaction patterns.
