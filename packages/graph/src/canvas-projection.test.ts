  ...
  it("projects source wiki topics as shared graph package behavior", () => {
    const projected = buildSourceWikiTopicProjection({
      ...
      nodes: [
        ...
        {
          id: "topic_src_1_probability",
          nodeType: "topic",
          labels: ["Topic"],
          properties: { title: "Probability", sourceId: "src_1" },
        },
        {
          id: "concept_1",
          nodeType: "concept",
          labels: ["Concept"],
          properties: { headingPath: ["Probability"] },
        },
        {
          id: "page_1",
          nodeType: "wiki_page",
        ...
        },
        {
          ...
          nodeType: "wiki_page",
          labels: ["WikiPage"],
          properties: { pageType: "topic", title: "Probability", sourceId: "src_1" },
        },
      ],
      edges: [
        {
          id: "e1",
          source: "topic_src_1_probability",
          target: "topic_page_1",
    ...
    expect(projected.nodes).toEqual(
      expect.arrayContaining([
        ...
        expect.objectContaining({
          id: "topic_page_1",
          nodeType: "wiki_page",
          properties: expect.objectContaining({ pageType: "topic" }),
        }),
      ]),
    );
