...
export const ingestionJobs = pgTable(
  ...
  (t) => [
    index("ingestion_jobs_ready_idx").on(t.status, t.runAt, t.priority),
    index("ingestion_jobs_notebook_idx").on(t.notebookId, t.createdAt),
    index("ingestion_jobs_source_version_idx").on(t.sourceVersionId),
  ],
);
...
export const agenticCacheEntries = pgTable(
  ...
  (t) => [
    index("agentic_cache_scope_idx").on(t.namespace, t.scopeType, t.scopeId, t.version),
    index("agentic_cache_expires_idx").on(t.expiresAt),
  ],
);
