...
const registry: Record<CanonicalGraphRelationKind, GraphRelationSemantics> = {
  depends_on: {
    ...
    postgresType: "depends_on",
    neo4jType: "DEPENDS_ON",
    direction: "source_to_target",
    learnerVisible: true,
    learnerLabel: "depends on",
    searchRole: "prerequisite",
    sourceOwned: true,
  },
  supports: {
    canonical: "supports",
    postgresType: "supports",
    neo4jType: "COVERS",
    direction: "source_to_target",
    learnerVisible: true,
    learnerLabel: "supports",
    searchRole: "supporting",
    sourceOwned: true,
  },
  example_of: {
    canonical: "example_of",
    postgresType: "example_of",
    neo4jType: "DERIVED_FROM",
    direction: "source_to_target",
    learnerVisible: true,
    learnerLabel: "example of",
    searchRole: "supporting",
    sourceOwned: true,
  },
  contradicts: {
    canonical: "contradicts",
    postgresType: "contradicts",
    neo4jType: "CONTRADICTS",
    direction: "bidirectional",
    learnerVisible: false,
    learnerLabel: null,
    searchRole: "contradicting",
    sourceOwned: true,
  },
  covers: {
    canonical: "covers",
  ...
  elaborates: {
    canonical: "elaborates",
    postgresType: "elaborates",
    neo4jType: "DERIVED_FROM",
    direction: "source_to_target",
    learnerVisible: true,
    learnerLabel: "elaborates",
    searchRole: "supporting",
    sourceOwned: true,
  },
  cites: {
  ...
  supersedes: {
    ...
    postgresType: "supersedes",
    neo4jType: "SUPERSEDES",
    direction: "source_to_target",
    learnerVisible: false,
    learnerLabel: null,
    searchRole: "hidden",
  ...
  contains: {
    canonical: "contains",
    postgresType: "contains",
    neo4jType: "CONTAINS",
    direction: "source_to_target",
    learnerVisible: true,
    learnerLabel: "contains",
    searchRole: "structure",
    sourceOwned: false,
  },
  plans: {
    canonical: "plans",
  ...
  has_topic: {
    canonical: "has_topic",
    postgresType: "has_topic",
    neo4jType: "HAS_TOPIC",
    direction: "source_to_target",
    learnerVisible: true,
    learnerLabel: "has topic",
    searchRole: "structure",
    sourceOwned: true,
  },
  contains_concept: {
    canonical: "contains_concept",
    postgresType: "contains_concept",
    neo4jType: "CONTAINS_CONCEPT",
    direction: "source_to_target",
    learnerVisible: true,
    learnerLabel: "includes concept",
    searchRole: "structure",
    sourceOwned: true,
  },
  contains_page: {
    canonical: "contains_page",
    postgresType: "contains_page",
    neo4jType: "CONTAINS_PAGE",
    direction: "source_to_target",
    learnerVisible: true,
    learnerLabel: "includes page",
    searchRole: "structure",
    sourceOwned: true,
  },
  derived_from: {
    canonical: "derived_from",
    postgresType: "derived_from",
    neo4jType: "DERIVED_FROM",
    direction: "source_to_target",
    learnerVisible: false,
    learnerLabel: null,
  ...
  next_objective: {
    canonical: "next_objective",
    postgresType: "next_objective",
    neo4jType: "NEXT_OBJECTIVE",
    direction: "source_to_target",
    learnerVisible: true,
    learnerLabel: "next objective",
    searchRole: "structure",
    sourceOwned: false,
  },
};
