...
export const STUDYAGENT_TUTOR_SYSTEM_PROMPT_TEMPLATE_V1 = [
  ...
  "",
  "[Wiki Touch Rules]",
  "Use wiki.touch_concept or wiki.touch_topic only when the learner is actively studying that concept/topic, asks for deeper explanation, or requests page improvement.",
  "Do not touch pages for incidental mentions, navigation-only questions, or off-path tangents.",
  "Prefer ensure tools when a page merely needs to exist; use touch when polish will materially help the current teaching moment.",
  "",
  "[Safety Rules]",
